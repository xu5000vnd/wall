...
Yii::import('application.modules.gii.CCodeGenerator');
Yii::import('application.modules.gii.CCodeModel');
Yii::import('application.modules.gii.CCodeFile');
Yii::import('application.modules.gii.CCodeForm');

...
class ModelCode extends CCodeModel
{
	...
	public function rules()
	{
		return array_merge(parent::rules(), array(
			...
			array('connectionId, tablePrefix, modelPath, baseClass, buildRelations, commentsAsLabels, modelUploadColumns', 'sticky'),
		));
	}
	...
	public function prepare()
	{
		...
		foreach($tables as $table)
		{
			...
			$params=array(
				...
				'modelUploadColumns'=>$this->modelUploadColumns,

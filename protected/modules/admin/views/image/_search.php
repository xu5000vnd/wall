<div class='search-form'>
    <section class="panel">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <?php echo $form->labelEx($model,'category', ['class' => 'col-lg-4 control-label']); ?>
                <div class="col-lg-8">
                    <?php echo $form->dropDownList($model,'category', Category::getParentCategory(), ['class' => 'form-control', 'empty' => 'All']); ?>

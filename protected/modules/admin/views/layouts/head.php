<title><?php echo !empty($this->pageTitle) ? $this->pageTitle : 'Walled' ?></title>
...
<!--external css-->
<!-- font icon -->
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/elegant-icons-style.css" rel="stylesheet" />
...
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/assets/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" />
<!-- easy pie chart-->
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
<!-- owl carousel -->
<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/owl.carousel.css" type="text/css">
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/jquery-jvectormap-1.2.2.css" rel="stylesheet">
<!-- Custom styles -->
